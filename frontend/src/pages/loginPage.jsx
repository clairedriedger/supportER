        ...
        <div className="">
            <div className="space-y-[100px]">
                ...
                <div className="flex flex-col items-center justify-center py-[30px] px-[50px] mx-[10px] bg-[#D9D9D9] rounded-[35px] space-y-[30px]">
                    <p className="text-justify font-semibold">When creating a username, it's important to protect your privacy. Avoid using personal information such as your real name, birthdate, or any other identifying details. Instead, get creative! Choose something unique and fun that reflects your interests or personality without revealing too much about yourself.</p>
